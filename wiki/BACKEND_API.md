# Comicraft Backend API Documentation

## Overview

The Comicraft Backend API provides comprehensive endpoints for AI-powered storytelling, NFT
...
- `https://comicraft.xyz` (production)
...
CORS_ORIGIN=https://comicraft.xyz
```
...
- GitHub Issues: [Comicraft Repository](https://github.com/Drago-03/Comicraft)
