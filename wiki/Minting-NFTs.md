...
# Minting NFTs with Comicraft 🖼️

<div align="center">
  <img src="../../public/Comicraft.png" alt="Comicraft Logo" width="300" />
</div>

Welcome to the exciting world of digital ownership with **Comicraft**! Our platform allows you to
...
Minting an NFT on Comicraft turns your story into a blockchain-based asset, creating a permanent
...
properties. In the context of Comicraft, minting your story as an NFT means creating a digital
...
NFTs on Comicraft are built on the Monad blockchain, currently using the Testnet for development,
...
Before you can mint an NFT on Comicraft, ensure you meet the following requirements to avoid
interruptions during the process:

1. **Connected Wallet**: You must have a cryptocurrency wallet linked to your Comicraft account.
...
2. **Monad Network**: Ensure your wallet is set to the **Monad Testnet** (Chain ID: 10143, RPC URL:
   ...
   Comicraft will prompt you to switch networks if necessary, or you can configure it manually in
...
Minting starts with a story, and Comicraft makes it easy to create content worthy of becoming a
digital asset. Follow these steps to prepare your story for minting:

1. **Access AI Story Generator**: Navigate to the "Create" section from the Comicraft homepage and
...
1. **Verify Wallet Connection**: Ensure your cryptocurrency wallet (e.g., MetaMask, WalletConnect)
   is connected to Comicraft and visible in the interface (usually in the header showing your
...
2. **Confirm Network Setting**: Check that your wallet is set to the **Monad Testnet** (Chain ID:
   10143). If on a different network (e.g., Ethereum Mainnet), Comicraft will prompt you to switch.
...
6. **Confirm Transaction in Wallet**: In your wallet (e.g., MetaMask), review the transaction
   ...
   - **Contract Interaction**: Ensure it's interacting with a Comicraft contract (verify the address
     ...
     needed—details in [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions)).
7. **Wait for Processing**: After confirming, the transaction will be processed on the Monad
   ...
   loading indicator or status message may appear in Comicraft during this time.
8. **Receive Confirmation**: Once the transaction is successful, Comicraft will display a
...
After minting, your NFT becomes a part of your digital collection on Comicraft and the Monad
...
- **NFT Gallery**: Access your minted NFTs by navigating to the "NFT Gallery" section from the
  Comicraft homepage or navigation menu. This gallery displays all NFTs you've created or own,
...
- **Blockchain Explorer (Advanced)**: For tech-savvy users, view detailed transaction and ownership
  ...
  NFT on-chain.
- **Trading or Selling (Future Feature)**: While Comicraft currently focuses on minting and
...
Here's a breakdown of these costs on Comicraft:
...
- **Testnet Fees (Current)**: On the Monad Testnet, used for development and testing, gas fees are
  ...
  - **How to Get Test Tokens**: Request test tokens from a Monad Testnet faucet (URL to be provided
    when available, check [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions)
...
- **Mainnet Fees (Future)**: Once Monad Mainnet is live for production use, fees will be paid in
  ...
  - **Payment**: Ensure your wallet holds enough Monad tokens to cover these fees when Mainnet
    launches.
- **Comicraft Service Fees**: Currently, Comicraft does not charge additional fees for minting
...
- **Wallet Not Connected Error**: If you see a "Wallet Not Connected" message or the minting button
  is disabled, click "Connect Wallet" in the Comicraft interface (usually in the header or minting
...
- **Wrong Network Detected**: If your wallet is on a different network (e.g., Ethereum Mainnet
  instead of Monad Testnet), Comicraft will prompt you to switch. Approve the switch in your wallet.
...
- **Transaction Failed or Reverted**: If the transaction fails, review the error message in your
  ...
  - **Contract Reverted**: This may indicate an issue with the story data or contract. Ensure your
    ...
    [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions) if persistent.
...
Congratulations on minting your first NFT with Comicraft! You've taken a significant step into the
...
[Back to Top](#minting-nfts-with-comicraft-️)
