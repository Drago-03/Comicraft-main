...
# Managing Your Account on Comicraft 👤

<div align="center">
  <img src="../../public/Comicraft.png" alt="Comicraft Logo" width="300" />
</div>

Welcome to **Comicraft**, the AI-powered Web3 storytelling platform where your creativity meets
...
Your Comicraft account is your gateway to exploring AI-generated storytelling and digital ownership
...
- [Creating a Comicraft Account](#creating-a-comicraft-account)
...
## 🆕 Creating a Comicraft Account

Getting started with Comicraft is simple and quick. Follow these steps to create your account and
unlock the full potential of AI storytelling and NFT minting:

1. **Visit the Comicraft Website**: Open your preferred web browser and navigate to the Comicraft
   homepage (URL to be provided upon launch, or access via development links in
   [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions)).
2. **Locate the Sign-Up Option**: On the homepage, find the "Sign Up" or "Create Account" button,
   ...
   page.
3. **Choose Authentication Method**: Comicraft offers flexible sign-up options to suit your
   preference:
...
Connecting a cryptocurrency wallet to Comicraft is a crucial step to interact with blockchain
...
2. **Navigate to Wallet Connection**: In the Comicraft interface, locate the wallet connection
   option:
...
4. **Authorize Connection**: Follow the wallet-specific prompts:
   - In MetaMask, select the account you wish to connect (if multiple exist) and click "Next," then
     "Connect" to grant Comicraft permission to view your address and request transactions.
...
6. **Verify Connection Status**: After connecting, the Comicraft interface should update:
...
Comicraft only gains permission to read your public address and request transaction approvals, which
you control via your wallet.

**Tip**: For security, always verify you're on the official Comicraft site (check the URL) before
...
Customizing your Comicraft account settings allows you to tailor your experience, update personal
information, and control preferences. Here's how to access and adjust your account details:

1. **Access Account Dashboard**: Log in to Comicraft and locate your account or profile section:
...
[GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions) for updates on new account
management tools as Comicraft evolves.
...
Comicraft operates on the Monad blockchain, and your connected wallet must be on the correct network
to interact with platform features like NFT minting. Here's how to switch networks in your wallet to
ensure compatibility:

1. **Understand Network Requirements**: Comicraft currently uses:
...
3. **Automatic Network Switch (Prompted by Comicraft)**: When performing blockchain actions (like
   minting an NFT), Comicraft detects if you're on the wrong network and prompts a switch:
   - A popup or notification will appear in the app, requesting to switch to Monad Testnet.
   - Click "Switch Network" or "Approve" in the Comicraft interface.
   ...
   - **MetaMask**:
     ...
     3. Enter the following details for Monad Testnet:
        ...
        - **Block Explorer URL**: (Leave blank or check
          [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions) for updates)
...
5. **Verify Network Switch**: After switching, confirm in your wallet that "Monad Testnet" is
   active. Refresh the Comicraft page if the app doesn't recognize the change immediately.
6. **Obtain Test Tokens (For Testnet)**: On Monad Testnet, you'll need test tokens for transaction
   ...
   - Faucet details will be shared in
     [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions) or platform
...
balance remains separate). Ensure you're on Testnet for current Comicraft features to avoid
transaction errors.

**Tip**: Bookmark or save the Monad Testnet configuration details for quick reference. If Monad
Mainnet launches, repeat this process with updated parameters provided by Comicraft to transition to
...
If you need to unlink your cryptocurrency wallet from Comicraft—whether for security, switching
wallets, or troubleshooting—follow these steps to disconnect safely:

1. **Locate Wallet Status**: In the Comicraft interface, find the wallet connection indicator,
...
3. **Confirm Disconnection**: Selecting "Disconnect" may prompt a confirmation dialog to ensure
   ...
   - No wallet signature or transaction is required for disconnection—it's a local action within the
     app.
4. **Verify Disconnection**: After confirming, the Comicraft interface should update:
...
5. **Alternative Disconnection (Wallet Side)**: Some wallets allow revoking app permissions
   directly:
   - In **MetaMask**, go to "Connected Sites" or "Permissions" in settings, find Comicraft (based on
...
**Note**: Disconnecting a wallet does not delete your account, NFTs, or stories on Comicraft. It
...
Encountering problems with your Comicraft account or wallet connection? Here are solutions to common
...
- **Wallet Connected but Features Locked**: If your wallet shows as connected but NFT minting or
  ...
  - **Session Expired**: Refresh the Comicraft page or disconnect and reconnect your wallet to
...
- **Error Messages During Transactions**: If wallet interactions (like signing messages) fail:
  - **Insufficient Funds**: On Monad Testnet, ensure you have test tokens for gas fees. Request from
    a faucet (details in [GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions)).
...
[GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions) or check the
...
Congratulations on mastering the management of your Comicraft account! With your account set up and
...
[Back to Top](#managing-your-account-on-comicraft-️)
