...
# Glossary for Comicraft

<div align="center">
  <img src="../../public/Comicraft.png" alt="Comicraft Logo" width="300" />
</div>

This glossary provides definitions and explanations for key terms and concepts used in Comicraft, an
...
- [Comicraft-Specific Terms](#comicraft-specific-terms)
- [Next Steps](#next-steps)

## AI and Technology Terms

- **Artificial Intelligence (AI)**: The simulation of human intelligence by machines, particularly
  computer systems. In Comicraft, AI is used to generate stories based on user inputs, leveraging
...
- **API (Application Programming Interface)**: A set of protocols and tools that allow different
  software applications to communicate with each other. Comicraft offers APIs for developers to
...
- **Groq**: A provider of AI models and infrastructure used by Comicraft for high-speed story
...
- **IPFS (InterPlanetary File System)**: A decentralized protocol for storing and sharing files.
  Comicraft uses IPFS (via services like Pinata) to store story metadata and content for NFTs,
...
- **Blockchain**: A decentralized, distributed ledger technology that records transactions across
  many computers. Comicraft uses the Monad blockchain to mint and manage story NFTs, ensuring
...
- **Cryptocurrency Wallet**: A software program or physical device that stores private and public
  keys for cryptocurrency transactions. In Comicraft, wallets like MetaMask or WalletConnect are
...
- **EVM (Ethereum Virtual Machine)**: A computation engine that executes smart contracts on
  Ethereum-compatible blockchains. Monad, used by Comicraft, is EVM-compatible, meaning tools and
...
- **Gas Fee**: A transaction fee paid to compensate for the computational resources used on a
  blockchain network. When minting NFTs on Comicraft (on Monad Mainnet), users pay a small gas fee
...
- **Mainnet**: The primary, production blockchain network where real transactions occur with real
  value. Comicraft plans to use Monad Mainnet for live NFT operations once available.
- **Monad Blockchain**: A high-performance, EVM-compatible blockchain designed for scalability.
  Comicraft uses Monad for NFT minting, currently on the Testnet (Chain ID: 10143) for development,
  with plans for Mainnet deployment.
- **NFT (Non-Fungible Token)**: A unique digital asset stored on a blockchain, representing
  ownership of a specific item or content. In Comicraft, stories can be minted as NFTs, proving
...
- **Smart Contract**: A self-executing program on a blockchain that automatically enforces agreement
  terms when conditions are met. Comicraft uses smart contracts on Monad for minting and managing
...
- **Testnet**: A testing blockchain network that mimics the Mainnet but uses valueless tokens for
  experimentation. Comicraft currently operates on Monad Testnet for NFT minting, allowing users to
  test features without real financial risk.
- **Token ID**: A unique identifier for an NFT on the blockchain. Each story NFT minted on Comicraft
...
- **Token URI**: A link (often to IPFS) stored in an NFT's smart contract that points to the
  metadata of the digital asset. In Comicraft, the Token URI connects to the story's content, title,
...
- **Web3**: A vision for a decentralized internet built on blockchain technology, emphasizing user
  ownership and control. Comicraft is a Web3 platform, integrating blockchain for NFT ownership and
...
- **Genre**: A category of artistic composition characterized by similarities in form, style, or
  subject matter. Comicraft supports multiple genres like Fantasy, Science Fiction, and Mystery,
  which users select to guide AI story generation. See
  [Creating Stories](../Creating-Stories.md#setting-story-parameters).
- **Motif**: A recurring theme, subject, or idea in a story. In Comicraft, users can specify motifs
  (e.g., "light versus darkness") in the story outline to shape the AI-generated narrative.
- **Narrative**: A spoken or written account of connected events; a story. Comicraft focuses on
...
- **Plot Outline**: A structured summary of a story's main events, conflicts, and resolution. Users
  can provide a plot outline in Comicraft to guide the AI in crafting a coherent story arc. See
  [Creating Stories](../Creating-Stories.md#customizing-your-story).
- **Setting**: The time and place in which a story occurs. In Comicraft, users can define the
...
- **Theme**: The central topic, subject, or message in a story. Users can input themes (e.g.,
  "courage and redemption") in Comicraft to add depth to AI-generated content.

## Comicraft-Specific Terms

- **AI Story Generator**: The core feature of Comicraft that uses AI to create stories based on user
...
- **Community Gallery**: A section of Comicraft where published stories (non-NFT) are displayed for
  other users to read and engage with. It's a place to share and discover free content.
- **Mint as NFT**: The process in Comicraft of turning an AI-generated story into a unique digital
  asset (NFT) on the Monad blockchain, establishing ownership and enabling potential trading. See
  [Minting NFTs](../Minting-NFTs.md).
- **NFT Gallery**: A dedicated area in Comicraft where users can view their minted NFTs or browse
...
This glossary will be updated as Comicraft evolves with new features and terminology. If you
encounter unfamiliar terms not listed here, ask in
[GitHub Discussions](https://github.com/Drago-03/Comicraft/discussions) for clarification.
