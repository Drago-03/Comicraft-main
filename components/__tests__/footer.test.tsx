...
describe('Footer', () => {
  ...
  it('displays the Comicraft brand name', () => {
    render(<Footer />);
    expect(screen.getByText('Comicraft', { selector: 'h2' })).toBeInTheDocument();
  });
  ...
  it('renders the current year in copyright', () => {
    ...
    expect(screen.getByText(new RegExp(`© ${currentYear} Comicraft`))).toBeInTheDocument();
  });
