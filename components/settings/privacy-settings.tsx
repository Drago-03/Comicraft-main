...
export default function PrivacySettings() {
    ...
    useEffect(() => {
        async function fetchPrivacy() {
            try {
                const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://comicraft-backend-api.onrender.com'}/api/v1/settings/privacy`);
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Manage how your profile and activity are seen by the Comicraft community.
                </CardDescription>
            </CardHeader>
