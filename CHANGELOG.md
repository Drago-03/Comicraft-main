...
- **Gemini Service**: Added `generateImage` to `server/services/geminiService.js` to process requests utilizing the Gemini 2.5 Flash Image REST API payload format.
