...
const allowedOrigins = [
  ...
  'https://comicraft.xyz',
  'https://comicraft.pages.dev',
  'https://comicraft.netlify.app',
].filter(Boolean);
      ...
      const isAllowed = allowedOrigins.some(allowed => {
        try {
          ...
          try {
            ...
            // Subdomain match (e.g., preview.comicraft.xyz matches *.comicraft.xyz)
...
app.listen(PORT, () => {
  console.log(`⚙️ Comicraft Worker service running on port ${PORT}`);
