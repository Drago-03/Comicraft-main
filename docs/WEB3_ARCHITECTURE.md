# Web3 Architecture — Comicraft / ComicCrafts

## Overview

Comicraft extends its storytelling platform with on-chain infrastructure on **Monad testnet**, using **CRAFTS** (ComicCraft Tokens) as the marketplace currency.
