...
This document tracks comprehensive accessibility improvements made to Comicraft to ensure WCAG 2.1
...
- Logo link has descriptive `aria-label="Comicraft home"`
...
npx axe https://comicraft.xyz --save axe-report.json

# Run Lighthouse accessibility audit
npx lighthouse https://comicraft.xyz --only-categories=accessibility --output=html --output-path=./lighthouse-report.html
```
