<h1 align="center">
  <img src="public/logo.png" alt="Comicraft Logo" width="150" />
  <br />
  Comicraft
</h1>
...
- [What is Comicraft?](#what-is-comicraft)
- [Features](#features)
...
```bash
git clone https://github.com/IndieHub25/Comicraft
cd Comicraft
npm install
...
See the [Wiki](https://github.com/IndieHub25/Comicraft/wiki) for configuration, environment
...
Comicraft ships with a production-ready Docker setup. The `docker-compose.yml` spins up all required
...
```bash
# Build the image
docker build -t comicraft .

# Cross-platform build (e.g., Mac M-series → amd64 cloud)
docker build --platform=linux/amd64 -t comicraft .

# Push to your registry
docker push myregistry.com/comicraft
```
...
Comicraft utilizes **Solidity-based** smart contracts for NFT minting and ownership management. We
...
> [!WARNING] **Safety Disclaimer:** Comicraft currently operates exclusively on the **Monad
...
Comicraft follows a decoupled architecture ensuring high-speed AI inference and decentralized
ownership.
...
Comicraft/
│
├── Comicraft/                # Core domain / main feature-specific logic
│
...
- **API Documentation:** [Wiki/API](https://github.com/IndieHub25/Comicraft/wiki/API) - Backend API
  reference
- **Smart Contracts:** [Wiki/Blockchain](https://github.com/IndieHub25/Comicraft/wiki/Blockchain) -
...
_Comicraft currently operates on Monad Testnet for NFT minting. Mainnet support coming soon—stay
tuned!_
