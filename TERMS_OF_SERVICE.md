...
Welcome to Comicraft, an AI-powered Web3 storytelling platform. By accessing or using our website
...
Comicraft ("we", "us", or "our"). We reserve the right to update or modify these Terms at any time,
...
You must be at least 13 years of age to use Comicraft. By using our services, you represent and
...
To access certain features of Comicraft, such as creating or minting NFTs, you may be required to
...
You agree to use Comicraft in a manner that is lawful, ethical, and in accordance with these Terms.
You shall not:
...
All content on Comicraft, including text, graphics, logos, and software, is the property of
Comicraft or its licensors and is protected by copyright, trademark, and other intellectual property
...
uploading content to Comicraft, you grant us a non-exclusive, worldwide, royalty-free license to
use, display, and distribute such content on our platform.

## 6. NFT Minting and Transactions

Comicraft allows users to create and mint NFTs as part of the storytelling experience. By minting an
NFT, you agree to:
...
Comicraft is provided on an "as is" and "as available" basis. We disclaim all warranties, express or
...
To the maximum extent permitted by law, Comicraft shall not be liable for any indirect, incidental,
...
You agree to indemnify, defend, and hold harmless Comicraft, its affiliates, officers, directors,
...
We reserve the right to terminate or suspend your account and access to Comicraft at our sole
...
By using Comicraft, you acknowledge that you have read, understood, and agree to be bound by these
Terms of Service.
