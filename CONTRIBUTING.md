...
Thank you for your interest in contributing to **Comicraft**, an AI-powered Web3 storytelling platform! We welcome developers, writers, designers, and blockchain enthusiasts to help us build a creative, open, and secure platform. Please read this guide before getting started.
...
Comicraft uses labels to help contributors understand scope, difficulty, and expectations.
...
1. **Clone the Repository:**
   ```bash
   git clone [https://github.com/IndieHub25/Comicraft.git](https://github.com/IndieHub25/Comicraft.git)
   cd Comicraft
   ```
...
Comicraft is organized for scalability and modularity. Here’s a high-level overview:
...
2. **Clone your fork locally:**
   ```bash
   git clone https://github.com/<your-username>/Comicraft.git
   cd Comicraft
   git remote add upstream https://github.com/IndieHub25/Comicraft.git
   ```
...
- Base: `IndieHub25/Comicraft` `main`
...
## CI & GitHub Actions
Comicraft uses GitHub Actions to ensure code quality and security.
...
- Keep the [Wiki](https://github.com/IndieHub25/Comicraft/wiki) up to date for setup, usage, and architecture.

---

## Community & Support
- **Discord:** [Join our Discord server](https://discord.gg/JK29FZRm) for real-time help and collaboration.
- **Discussions:** Use [GitHub Discussions](https://github.com/IndieHub25/Comicraft/discussions) for ideas and Q&A.
...
Thank you for contributing to Comicraft! If you have any questions, open an issue, ask in Discord, or contact the maintainers directly.
