...
Comicraft follows a rolling support window. The latest minor release receives full support (features +
...
1. **GitHub Private Reporting (Recommended):** Please report vulnerabilities via the
   **[Security Tab](https://github.com/IndieHub25/Comicraft/security/advisories)** on GitHub. This
...
Comicraft takes the security of user data seriously. We implement industry-standard measures to
...
If you find a vulnerability in a third-party package we use that directly affects Comicraft, you may
