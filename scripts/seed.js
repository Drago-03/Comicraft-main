...
const MONGODB_URI =
  process.env.MONGODB_URI || 'mongodb://localhost:27017/comicraft';

const users = [
  { username: 'stella_writer', email: 'stella@comicraft.xyz', firstName: 'Stella', lastName: 'Nova', bio: 'Sci-fi dreamer and worldbuilder.', badges: ['Alpha Tester'], role: 'user' },
  { username: 'dark_ink', email: 'dark@comicraft.xyz', firstName: 'Marcus', lastName: 'Reed', bio: 'Horror and mystery enthusiast.', badges: [], role: 'user' },
  { username: 'luna_tales', email: 'luna@comicraft.xyz', firstName: 'Luna', lastName: 'Chen', bio: 'Fantasy lover, dragon tamer.', badges: ['verified'], role: 'user' },
  { username: 'cyber_sage', email: 'cyber@comicraft.xyz', firstName: 'Kai', lastName: 'Tanaka', bio: 'Cyberpunk chronicles and neon prose.', badges: [], role: 'user' },
  { username: 'rose_romance', email: 'rose@comicraft.xyz', firstName: 'Rose', lastName: 'Harper', bio: 'Love stories that make your heart sing.', badges: [], role: 'user' },
  { username: 'adventure_max', email: 'max@comicraft.xyz', firstName: 'Max', lastName: 'Sterling', bio: 'Explorer of fictional worlds.', badges: ['Alpha Tester'], role: 'user' },
  { username: 'mystery_mo', email: 'mo@comicraft.xyz', firstName: 'Morgan', lastName: 'Blake', bio: 'Every story hides a clue.', badges: [], role: 'user' },
  { username: 'neon_dreamer', email: 'neon@comicraft.xyz', firstName: 'Neon', lastName: 'Park', bio: 'AI art and generative fiction.', badges: [], role: 'user' },
  { username: 'admin_drago', email: 'admin@comicraft.xyz', firstName: 'Drago', lastName: 'Admin', bio: 'Platform administrator.', badges: ['verified'], role: 'admin' },
  { username: 'demo_user', email: 'demo@comicraft.xyz', firstName: 'Demo', lastName: 'User', bio: 'Welcome to Comicraft!', badges: [], role: 'user' },
];
...
async function seed() {
  try {
    ...
    const oldSeedUsers = await db.collection('users').find({ email: { $regex: /@comicraft\\.xyz$/ } }).toArray();
