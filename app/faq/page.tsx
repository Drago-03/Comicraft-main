          ...
          <TabsContent value="general">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Basic information about Comicraft
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem
                    value="what-is-comicraft"
                    id="what-is-comicraft"
                  >
                    <AccordionTrigger>What is Comicraft?</AccordionTrigger>
                    <AccordionContent>
