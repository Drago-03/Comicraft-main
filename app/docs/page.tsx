        ...
        <section className="mb-20">
          ...
          <div className="space-y-8">
            <StepCard
              ...
              description="Sign up using your email or connect directly with your Web3 wallet. Complete your profile to start creating and collecting stories on Comicraft."
        ...
        <section className="mb-20">
          ...
          <div className="space-y-4">
            <FaqItem
              index={0}
              emoji="🤖"
              question="What is Comicraft?"
              answer="Comicraft is a platform that combines AI-powered storytelling with blockchain technology. Create unique stories using Groq's lightning-fast AI, mint them as NFTs on the Ethereum blockchain, and share them with a global community of readers and collectors."
            />
            <FaqItem
              index={1}
              emoji="⚡"
