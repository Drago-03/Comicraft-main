...
// useEffect(() => {
//   fetch(`\${process.env.NEXT_PUBLIC_API_URL || 'https://comicraft-backend-api.onrender.com'}/api/settings/notifications`)
//   .then(res => res.json())
...
// useEffect(() => {
//   if (address && chain) {
//   fetch(`\${process.env.NEXT_PUBLIC_API_URL || 'https://comicraft-backend-api.onrender.com'}/api/settings/wallet`,{
//     method: "GET",
...
//             <CardDescription>
//               Customize how Comicraft looks for you
//             </CardDescription>
//           </CardHeader>
//           <CardContent className="space-y-6">
//             <div className="space-y-4">
