...
// useEffect(() => {
//   fetch(`\${process.env.NEXT_PUBLIC_API_URL || 'https://comicraft-main.onrender.com'}/api/settings/notifications`)
//   .then(res => res.json())
...
// useEffect(() => {
//   if (address && chain) {
//   fetch(`\${process.env.NEXT_PUBLIC_API_URL || 'https://comicraft-main.onrender.com'}/api/settings/wallet`,{
//     method: "GET",
