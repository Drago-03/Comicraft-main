      ...
      <div className="container max-w-4xl mx-auto px-4 py-12 md:py-20">
        ...
        <header className="mb-16 text-center lg:text-left">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/60 drop-shadow-sm font-display" style={{ fontFamily: 'var(--font-comic)' }}>
            Comicraft: Building an AI‑Native Storytelling Engine on Blockchain
          </h1>
        ...
        <article className="text-lg md:text-xl max-w-none 
          ...
          <p className="lead text-xl md:text-2xl text-foreground/90 font-medium mb-12" style={{ fontFamily: 'var(--font-comic)' }}>
            You think "Write a noir heist set in a neon Delhi, mint it on-chain, split royalties with my co-writer, and don't make me touch a smart contract." That's the experience we're trying to build with Comicraft.
          </p>
          ...
          <h2>TL;DR – What is Comicraft?</h2>
          <p>Comicraft is an AI-powered, on-chain storytelling platform:</p>
          <ul>
          ...
          <div className="flex flex-col sm:flex-row gap-4 my-10 p-6 rounded-2xl bg-white/5 border border-white/10 shadow-lg backdrop-blur-sm">
            <div className="flex-1 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                <a href="https://www.comicraft.xyz/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg font-bold text-sm hover:scale-105 transition-transform shadow-[0_4px_14px_rgba(255,77,109,0.4)] no-underline">
                  Live site
                </a>
                <a href="https://github.com/IndieHub25/Comicraft" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-[#24292e] text-white rounded-lg font-bold text-sm hover:scale-105 transition-transform shadow-lg no-underline border border-white/10">
...
function mintStory(
  ...
  ContributorShare[] memory shares
          ...
          <ol className="space-y-4">
            <li><strong>Explore the platform:</strong> Open <a href="https://www.comicraft.xyz">comicraft.xyz</a> and poke around the Pro Panel. Break it. See where it feels clunky or magical.</li>
            <li><strong>Star & watch the repo:</strong> Stars genuinely help surface the project to other builders. Give it a star <a href="https://github.com/IndieHub25/Comicraft">on GitHub</a>.</li>
          ...
          <blockquote className="text-xl">
            If you've ever looked at an NFT drop and thought, "the art is cool but the story deserved better" — Comicraft is my attempt to fix that.
          </blockquote>
