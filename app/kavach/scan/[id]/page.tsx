...
import { PIPELINE_STEPS, LICENSE_TIERS, RISK_LEVELS, COMPLIANCE_BADGES, LEGAL_REFERENCES } from '@/lib/kavach/constants';
import type { KavachScan, PipelineEvent, ScanAuditEntry } from '@/lib/kavach/types';

export default function ScanDetailPage() {
  const { id } = useParams<{ id: string }>();
  const { events, scan: liveScan } = useKavachRealtime(id);
