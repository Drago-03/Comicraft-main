...
/**
 * @title EthereumStoryNFT
 * @dev ERC-721 NFT contract for Comicraft story minting on Ethereum Mainnet.
 *      Formerly known as MonadStoryNFT — migrated to Ethereum Mainnet (Chain ID: 1).
 *      Mint price: 0.001 ETH (real mainnet ETH). Max supply: 10,000 tokens.
 *      Story content hash (IPFS CID) stored on-chain per token.
 */
contract EthereumStoryNFT is ERC721URIStorage, Ownable, ReentrancyGuard {
  uint256 private _tokenIdCounter;

  // Base URI for metadata
  string private _baseURIextended;

  // Minting price (0.001 real ETH on Ethereum Mainnet)
  ...
  constructor() ERC721('Comicraft Story NFT', 'GTALE') Ownable() {
